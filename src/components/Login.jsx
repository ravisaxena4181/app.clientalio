    ...
    <div className="login-container">
        ...
        <div className="login-form-wrapper">
          <div className="login-card">
            ...
            <div className="signup-link">
              New to Clientalio? <a href="/signup">Sign Up!</a>
            </div>
          </div>
        </div>

        <div className="login-footer">
          © 2025 <a href="https://clientalio.com">Clientalio</a> All rights reserved.<br />
          Developed with ❤️ in India by <a href="#">BWays Techno Solution</a>
        </div>
      </div>
      ...
      <div className="login-right">
        <div className="welcome-message">
          <h2>Welcome back!</h2>
          <p className="tagline">Join us to collect testimonials from your clients and get noticed.</p>
        </div>
      </div>
    </div>
  );
