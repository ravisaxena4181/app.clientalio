...
const Onboarding = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err || 'Failed to complete profile. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSkip = () => {
    // Skip to dashboard without completing profile
    navigate('/dashboard');
  };
    ...
    <div className="flex min-h-screen bg-gray-50 items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <label className="cursor-pointer px-6 py-2 bg-white border-2 border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
            <input
              type="file"
              accept="image/*"
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="input-group">
            <input
              ...
              className="border-0 border-b-2 border-gray-300 focus:border-primary rounded-none px-0 py-2"
            />
          </div>
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? <span className="loading"></span> : 'COMPLETE'}
          </button>
        </form>
        ...
        <div className="text-center mt-4">
          ...
          >
            I will do it later?{' '}
            <span className="text-primary font-semibold">skip!</span>
          </button>
        </div>
